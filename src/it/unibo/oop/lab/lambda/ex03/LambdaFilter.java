...
public final class LambdaFilter extends JFrame {
    ...
    private enum Command {
        IDENTITY("No modifications", Function.identity()), LOWERCASE("Lowercase", a -> a.toLowerCase()),
        CHARCOUNTER("Char counter", a -> Integer.toString(a.length())),
        LINECOUNTER("Line counter", a -> Long.toString(a.lines().count())),
        ALPHABETICAL("Alphabetical", a -> a.lines().sorted().collect(Collectors.joining(System.lineSeparator()))),
        WORDCOUNTER("Word counter", a -> Arrays.stream(a.split(" "))
